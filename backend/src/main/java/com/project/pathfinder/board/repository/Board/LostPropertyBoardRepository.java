...
//    @Query("SELECT b FROM LostPropertyBoardEntity b WHERE b.boardTitle LIKE %:keyword%")
//    List<LostPropertyBoardEntity> findByBoardTitleContaining(@Param("keyword") String keyword);

//    List<LostPropertyBoardEntity> findByBoardTitleContaining(String boardTitle);
